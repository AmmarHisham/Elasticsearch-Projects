...
public class SwaggerConfig {
	...
	private static final String TITLE="Convergence Search REST API";
	private static final String DESCRIPTION="Used for searching the convergence details";
    ...
    public Docket swaggerSpringfoxDocket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select().apis(RequestHandlerSelectors.basePackage("com.nbc.app.controller"))
